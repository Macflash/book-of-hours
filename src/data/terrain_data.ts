export const TerrainData = [
  ...
  },
  {
    ...
    desc: "Giver, Teller, Shur's Tongue, Lady Janice and Great Paycock are the names of these bells, though they're older than the Abbey itself and those names have certainly been corrupted over the years. By 1915, Shur's Tongue and Lady Janice were too cracked to ring, and the Suppression Bureau paid for them to be recast - Serena Blackwood's <i>quid pro quo</i> for the assistance she gave George Collers with his clock project.\n\n",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { sky: 11, forge: 11, heart: 11 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "The best way to come to Brancrug unnoticed. Most recently, an unofficial means for Suppression Bureau officials to come and go.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moon: 13, rose: 13 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "This quiet Cornish fishing village has lain long in the Isle's shadow. It might be as old as Hush House itself. And like Hush House, Brancrug Village has provided sanctuary over the years for its share of misfits and exiles.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "Guidance",
        description: "One last time, depend on the kindness of strangers.",
        required: {},
        forbidden: { sceptical: 1 },
        essential: { assistance: 1, sky: 1 },
      },
    ],
    fx: { "brancrug.open": 1 },
    warmup: 5,
  ...
  },
  {
    ...
    startdescription: "",
    desc: "Here the sea ends and the world begins (or the other way around). After storms, the fishermen of Brancrug Village find oddities washed up here.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
  ...
  },
  {
    ...
    desc: "Seventy-seven days in the Cucurbit was considered enough to soften the passions of the most unrepentant adept. After that, they were usually charged and tried in closed court; very occasionally released; sometimes taken upstairs for one of Collers' experimental interviews.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 12, forge: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "cell-adept.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "This was the last prisoner to be admitted to the Gaol, but only the date has been recorded. No record of its origin, crime, or arrest remains. Collers was a man of many secrets. Sometimes, however, he was also a generous man, and he insisted it be provided with a bed and with writing materials, should it ever feel the need for them.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 14, moth: 14, scale: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "cell-unknown.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The occupant of <i>this</i> cell could not be allowed fresh air and exercise. It could not have reasonably expected to leave this cell ever again, even while it wore human shape. But it could not be confined forever; in the end, somehow, it found its way into the walls.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 15, sky: 15, forge: 15 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "cell-worm-inhabited.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    label: "Chapel Ascite",
    startdescription: "Icy mists coil and drift.",
    desc: "The Horned-Axe says: Never speak of this Mystery. When the Thunderskin was mortal, he served the Hours who slew my kind. I required the Thunderskin's death, and so the Grail gave him up. There is always a reckoning, and nothing is truly forgiven.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 14, edge: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "chapelascite.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription: "Crimson mists beckon and sway.",
    desc: "The Red Grail says: Never speak of this Mystery. I was always the first, and I must always be greatest. When we spilt the blood of the Thunderskin, I feasted and I grew strong, stronger again than the Twins. There is always a feast, and nothing is truly wasted.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 14, nectar: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "chapelcalicite.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The Ring-Yew says: Never speak of this Mystery. When the Thunderskin was mortal he loved me first, and so the Grail destroyed him. Now the Thunderskin delights forever in my succulence. There is always a renewal, and nothing truly ends.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { nectar: 14, heart: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "chapelmalachite.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "The bells in this tower rang every Sunday, even in Solomon Husher's time, until Thirza Blake finally cancelled services so she could save money by sacking the priest. This brought a deputation of angry locals from Brancrug Village, where there was a fearful superstition that when the bells of Brancrug fell silent, the bells of Ys would be heard.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { sky: 9, forge: 9, lantern: 9 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "churchtower1.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "George Collers, governor of Brancrug Gaol, oversaw the design and installation of this great clock, with the reluctant help of the Librarian Serena Blackwood. She might have refused outright, had she known how he intended to reuse the horologist's techniques for his so-called 'condignator'.\n\nAn inscription on the greatest wheel reads 'STRIKE THE HOURS'.\n\n",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 10, sky: 10, winter: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "churchtower2.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The sisters and brothers of the Abbey built these gardens in the thirteenth century - at the height of the period we now call Solar Gothic. Walk here a while and breathe the peace they left.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { nectar: 2, lantern: 2 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "The Governor's office - quietly luxurious, at least by the standards of the Cucurbit. Collers was devoted to his cause and his service, but he did insist on his little pleasures.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 12, heart: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "crucibletower1.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "When a prisoner resisted all other interventions, Collers would bring them here, to test and refine their worth. His successes might be transferred to Zurich, or turned over to the Légion du Seuil to earn their humanity, or even, at least once, released. But his successes were not numerous.\n\nHere, at last, is where the fire began and where it ended. When the power below the prison was released, it came here to interview Collers. Perhaps it intended to put him in his own device; but it seems there was not nearly enough left of him for that.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 14, moth: 14, knock: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "crucibletower3.open": 1 },
    warmup: 60,
  ...
  },
  {
    ...
    desc: "Hush House has been many things over the centuries - including, in the Nocturnal Period of 1896-1929, a gaol. No-one remembers that period fondly, but at least it meant Nocturnal Branch paid for a new bridge.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "Repairs",
        ...
        required: { forge: 1, lantern: 1, sky: 1 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "cucurbitbridge.open": 1 },
    warmup: 5,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "When the gods-from-stone were swept away, the Carapace Cross who had served them were swept away too. The Seglaz-kind, the Wyrmefota-kind, the Glaeterfloge-kind, all those wise and mighty ones are gone, into Nowhere or hiding or us. Here in the fire-warmed waters, away from the justice of sunlight, their legacy quietly thrives.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { nectar: 14, moon: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "deeplightcaves.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "Each of the great roots here carries a garden of fruiting fungus. Great black bumblebees buzz improbably between them, gathering spores, droning peace.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { scale: 9, heart: 9, nectar: 9 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "deepwelldescent.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    label: "Earth Cellar",
    startdescription: "The roof has fallen in. We'll need to dig it out.",
    desc: "In the time of the Abbey, this was a shrine to St Lucia the Eyeless. Since the heresies of the Intercalate, the Church of the Unconquered Sun considers her an aspect of the Hour called Meniscate, but back then she was just the patron saint of stained-glass workers and eye doctors. The tree in Earl Brian's Field outside was traditionally hung with stained-glass ornaments on St Lucia's day.\n\nSince the dissolution of the Abbey, though, it's mostly been vegetables in here.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { scale: 11, nectar: 11, heart: 11 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "earthcellar.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The beginning of the House proper. The Curia used to issue gloves and slippers of soft leather to protect the books and premises. Visitors were often asked to remove their shoes. Pause a moment and listen to the Histories.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 3, rose: 3 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "entrancehall.open": 1 },
    warmup: 10,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    label: "Fludd Gallery",
    startdescription:
      "This was an alchemist's workshop and a picture gallery, but the pictures have been flung down, the vessels overturned, the solvents and reagents spilt. It will be time-consuming and dangerous to repair.",
    desc: "Thirza Blake, seventh Librarian of the House, extended this space, decorating it with semi-precious materials and filling it with the finest art Hush House's money could buy. (Of course, after her enthusiasms brought the House to the brink of penury, much of it had to be sold off.)",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 6, winter: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "fluddgallery.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "Brancrug Gaol: built in 1896 at the behest of Nocturnal Branch, to contain 'troubles unseemly and occult'. A mere six years later, after the Ortucchio Incident, the Branch came itself to be considered 'unseemly and occult', and its functions were absorbed into the Suppression Bureau. But the Gaol still stands.\n\nOver the gate is the Bureau's motto: ALIIS SI LICET, TIBI NON LICET, commonly rendered as IT IS PERMITTED TO US; IT IS NOT PERMITTED TO YOU.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 9, edge: 9, forge: 9 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gaolbridge.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The entrance to the sub-cellar was barred, locked, chained, warded, both physically and otherwise. Whatever was kept down there, they took it extremely seriously.\n\nIt looks very much as if the questing Worms broke the seals, drawn by the power below. It looks very much as if they regretted it.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 13, scale: 13, winter: 13 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gaolcellar.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "Here the guards and the prisoners would take their meals. Sometimes Collers, too, would descend from his tower and discuss philosophy with poisoners, ethics with Antaians, theology with labhites. Afterwards he would generally burn his notes.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moth: 11, forge: 11, winter: 11 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "'There are no Hours at Brancrug,' Collers used to say - even before he was Governor of Brancrug Gaol, when he was only Secretary Vigilant of the Curia. By way of reminder, the hands were confiscated from every timepiece within the prison walls. The warders could still rely on the chimes of the great Clock in the abbey spire. But it did make life harder for the cooks.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 12, heart: 12, winter: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gaolkitchen.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The gaol was nicknamed the 'Cucurbit', for the alchemist's flask that distils and refines. Prisoners would become better versions of themselves, realigned to responsibility. Hence, though it would have been much safer to confine the more potent inmates to their sealed cells, Governor Collers insisted that even they should be allowed fresh air and exercise.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { heart: 10, grail: 10, winter: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "Each stair tread is decorated with a quotation from the Book of Suns, so that the congregation might be edified as they ascend. The quotes are worn to half-legibility by the passage of all those worshipful feet, which may be why some of these quotations differ troublingly from any orthodox version.\n\nIt has of course been claimed that the Sisterhood of the Knot, who first held the Isle, also held a copy of the long-suppressed Shuritic version of the Book...",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 6, forge: 6, edge: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gloriousstair.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription:
      "The windows are tightly closed, the carpets surprisingly clean, but my skin prickles at the watchful presence in the stairwell. We will need to placate it before we go higher.",
    desc: "By long tradition, each Baron Brancrug had their image set in a niche in the Grand Ascent. Later, the Curia of the Isle continued the tradition for their Librarians.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { heart: 4, winter: 4, sky: 4, forge: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "grandascent.1.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription:
      "It is unexpectedly difficult to raise my foot to the last step before the landing. Leaf-shadows drift across my sight, and the windows hiss and rattle. I have heard that Gervinus van Lauren, last Librarian before me, was skilled at the forbidding of ways.",
    desc: "By long tradition, each Baron Brancrug had their image set in a niche in the Grand Ascent. Later, the Curia of the Isle continued the tradition for their Librarians.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { nectar: 5, winter: 5, knock: 5, grail: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "grandascent.2.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription:
      "Frost crackles on the window-panes as I ascend, and the light strikes at my eyes like knives. Another of van Lauren's forbiddings.",
    desc: "By long tradition, each Baron Brancrug had their image set in a niche in the Grand Ascent. Later, the Curia of the Isle continued the tradition for their Librarians.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { edge: 5, winter: 5, knock: 5, forge: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "grandascent.3.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription:
      "The stairs here are clear, but the air here is thick with old magics. I should move carefully, and I should not go alone.\n\nStill no sign of any fire. Why then was the House abandoned?",
    desc: "The staircase that served as the spine of the House: Baron Walter's great project, executed by the master mason Gregory Wheelock.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { heart: 4, winter: 4, edge: 4, moon: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "grandascent.g.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "Through all the Isle's long years, the gulls, heedless of our affairs, have taken their due from the sea and returned it to the rocks. Careful where you step.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { sky: 12, edge: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gullcolony.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "In his youth, Baron Valentine inclined to religion, and he made pilgrimages to holy sites on the Continent. After he made his final pilgrimage - to Fermier Abbey - the dreams began - of blood seeping from the earth; of a vast and pulsing Wheel crushing the temples of men; and, which troubled him most, of twisted birds, shrieking in pain, growing like fruit in the branches of an ancient yew.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 10, sky: 10, heart: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gullscrytower1.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
    ...
    preslots: [
      {
        ...
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 11, sky: 11, winter: 11 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gullscrytower2.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "In 1721, Valentine fell - or leapt - from the tower top. There were no witnesses, and his body was not found for three days. His daughter Eva was the last to see him alive, and of their last conversation, she would say only that he had begun to fear the sun.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 12, sky: 12, rose: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "gullscrytower3.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "Eva Dewulf first furnished this as her Hall of Division, holding feasts where the guests were selected by unusual and exacting criteria. Later, Thirza Blake, seventh Librarian, employed the speculist Poemander to add more mirrors. <i>Lots</i> more mirrors.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { edge: 8, winter: 8 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "hallofmirrors.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "The words RED WILLIAM are scratched into the wall by the bed-nook. This was the name of the cunning-man who laid a curse on Hendrik Dewulf, that there would be no seventh of his line - the cunning-man that Hendrik Dewulf gelded and imprisoned beneath the House.\n\nBut this doesn't look like a cell. There could have been no locks. Perhaps that other story is true - that William was an initiate of the Thunderskin, secretly maintained by Hendrik to prophesy for him 'in the ancient manner.' Who were the Dewulfs, really?\n",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moth: 12, heart: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "hermitcell.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "How did the Curia of the Isle begin? There is no evidence they began with the House of Lethe, that society of unseen immortals bound by three oaths. But this vault - much newer than the tunnels above - does seem to reference the oath called the Ivory Chain, which forbade commerce with the Hours - except, sometimes, with the winter Hour known as the Elegiast, or the Ivory Dove. Solomon Husher remarked that this might be considered less an oath of rejection of the Hours, and more an oath of loyalty to the Elegiast. But Solomon, of course, vanished into the snow.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { scale: 14, knock: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "ivoryvault.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    label: "Kitchen",
    startdescription:
      "Finally, signs of a fire - but it looks as if, fortunately the chimney-breast collapsed before it could spread too far. It can't be why the House was abandoned. In any case, the kitchen will need skilled labour to restore it to a usable state.",
    desc: "'Kingsluck pie' - a beef pie with pears and cinnamon and secret ingredients - is the traditional dish of the House. It was first cooked, they say, for King Henry, when in great secrecy on St Piran's Day he came to Cornwall seeking the 'King's Metal', tin, to 'restore his Alloy'. It probably didn't happen. But the pie did.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 6, sky: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    startdescription:
      "This place has been surrendered to wind and weed. Bees buzz menacingly. Somewhere, something clucks plaintively.",
    desc: "In 1652, Musgrave Dewulf caught a travelling pedlar stealing vegetables from this garden - an eccentric wanderer who went by 'Ricardo Milagro'. Musgrave's ancestors would simply have hung the fellow, but Musgrave decreed seven years' service in the garden instead. When the seven years were up, Milagro had proved his worth as a gardener and chose to make Brancrug his home. The grapevines here are cultivated with rootstock he carried in his pack.\n",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { nectar: 9, grail: 9 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "kitchengarden.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "When the Curia of the Isle acquired the deed to the abandoned Dewulf estate, Ambrose Westcott became first Librarian, and had this cosy nook constructed above the north wing to fit his preferences. His successor Kitty preferred the room next door (she lamented that the reek of Westcott's pipe remained long after his death) and her successor, Solomon Husher, preferred the Long Tower for his own chilly reasons. But most Librarians have enjoyed the peace and the sea view.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { lantern: 3, scale: 3, heart: 3, forge: 3 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "librarianquarters.open": 1 },
    warmup: 60,
  ...
  },
  {
    ...
    desc: "Here the supplies came in, from every continent that the seas touch - from the Bounds, and beyond. Now and then prisoners would try to escape, but the sea is always hungry.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { rose: 14, moon: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "loadingdock.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "For five hundred years - in the times we call Baronial, Curia, Nocturnal - there was always a keeper to watch the ways, weed the gardens, mend the roof when the sun was shining. There is no keeper now, but the Lodge's roof still weathers the storms of Brancrug Bay.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "Entrance",
        ...
        required: { forge: 2, knock: 1, heart: 1 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "In 1818, the Very Reverend Solomon Husher became third Librarian of the Curia of the Isle. He took rooms in the Long Tower as his quarters. Husher's tastes were spartan; although the Curia generally liked a little more luxury, no-one ever quite dared to redecorate the place after his disappearance.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 3, lantern: 3 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "longtower1.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "Generally reckoned the chilliest room in the House. The Long Tower was usually called the Winter Tower until Julian Coseley - magus, epistler, reputed Long - dwelt here briefly in the seventeenth century. Solomon Husher was the second known to sleep in the room. Evidently they didn't mind the cold.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 4, lantern: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "longtower2.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The Curia installed these pumps when the lower levels of the Sisterhood's holy place were already dry. Why? What were they looking for? What lies beneath Brancrug Isle that even the Sisterhood never found?",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 3, knock: 3 },
        forbidden: {},
        essential: { circumstance: 1 },
      },
    ],
    fx: { "lowerpumproom.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "At the turn of the century, Sir David Greene - eighth librarian and former Nocturnal Branch superintendent - had this room refurnished to plan his explorations, and to manage the operations of his many agents.\n",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { rose: 6, sky: 6, heart: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "mapchamber.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    label: "Mazarine Room",
    startdescription:
      "The room reeks like a rotting reptile. The curtains ripple restlessly with the watchful presences that van Lauren left behind. Perhaps I can find someone to sing them to sleep.",
    desc: "'Kitty's pride, and the House's joy.' Kitty Mazarine was better known for her vocal compositions, but she was a versatile musician, and on winter evenings she'd invite visitors and villagers alike to her recitals.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { sky: 6, heart: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "mazarineroom.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "This room may originally have served as a working dispensary, but some at least of its more eccentric fittings were added by Christopher Illopoly in his time here. By that point he had severed ties with his adoptive father. He'd been using the Illopoly name for years and had no access to the Strathcoyne fortune - but 'Traveling at Night' had sold surprisingly well (much better than his poetry) and he had a little money of his own by then - enough to indulge his preferences.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moth: 6, heart: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "motleytower2.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "If you were a pilgrim to the Abbey of the White Crow, you'd purify yourself here. You didn't want to track profane Dumnonian mud or alien Mare Britannicum salt into the holy precincts. Or unclean thoughts. Especially not unclean thoughts. The priestesses here were a little more merciful than the Hours they served, but only a little.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { scale: 14, edge: 14, knock: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    startdescription:
      "This has long been a holy place, but shadows are the only worshippers here now. The windows have been painted black, the pews overturned, the organ hung with black ribbons.",
    desc: "For a thousand years the Unconquered Sun has been worshipped here in all his Aspects - though since the heresies of the Intercalate, many of those aspects are considered distinct Hours in their own right, and the Sun's death and birth are both now celebrated.\n\nThe Abbey Church used to be more golden, but many of the valuables were lost at the Abbey's dissolution, including the original stained glass. These magnificent windows are of recent manufacture, financed by the eighth Librarian, Greene, who was a believer of the Second Dawn variety.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { lantern: 6, heart: 6 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "In the 1850s, and in deep secrecy, Natalia Brulleau built the Night Gallery into the foundations of the Gullscry Tower. Behind this heavy steel door the Curia, and later the Suppression Bureau, kept treasures too difficult for common view, but too relevant to consign to a deeper vault. If anything difficult might, hypothetically, have been inclined to creep up the stairs from below, it would also have been discouraged by that door.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moon: 10, winter: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "nightgallery.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription: "",
    desc: "Whale-den, moon-road, bone-keeper, ship-breaker.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
  ...
  },
  {
    ...
    desc: "Here in a vessel shaped by fire and fate, George Collers confined a flame in human flesh, a blazing shadow of a blazing future, a Name of greed and time. Greene called it 'the Sun's bastard grandchild.' Van Lauren warned of 'the Second Dawn's first spark'. But Collers spoke of it reverently: as 'the Leashed Flame's true heir'.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 15, knock: 15, forge: 15 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "Who is 'Our Lady'? The Red Grail, which gives life, which takes life, which is not sated? The Horned-Axe, who bears two blades, who waits at the threshold, who sunders that which should not be joined? The Ring-Yew, who is succulent, who is renewed, who encompasseth? Or a fourth, who is always signified but never named?\n\nA Librarian might phrase the question differently: who was first?",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { knock: 4, nectar: 4, moth: 4, winter: 4 },
        forbidden: {},
        essential: { liquid: 1 },
      },
    ],
    fx: { "ourladybeneath.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "In the time of the Dewulfs, this magnificent bedroom was reserved for the Baron... or in Lady Eva's time, the Baroness. Eva had the whole room decorated in black as a gesture of permanent mourning for her father Valentine (or, according to ribald rumours, to set off her own paleness for her lovers). It was Kitty Mazarine, much later, who freshened the furnishings and made it the Pale Chamber.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { winter: 7, moth: 7 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "palechamber.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "The nuns of the Knot planted this garden of healing herbs in the Dawn Period. Natan of Regensburg and Gideon Dewulf both expanded it, and the Curia of the Isle tended it. Even the Branch and the Bureau made use of it in the grim days that Brancrug served as a prison.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { heart: 3, nectar: 3 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "physicgarden.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "In the early days of St Brandan's Abbey, the brothers practiced the arts of war here. So it was that in Baronial times the garden became a favourite of the martial, quarrelsome Dewulfs.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { edge: 4, nectar: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "practicgarden.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "Visitors were usually permitted this far into the House, and no further. In the days when the Librarians commanded the services of the Fine-Takers, visitors were sometimes even left unsupervised.\r",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { rose: 5, lantern: 5 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "readingroom.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "The Eye marked on the rocks here is not the Watchman's Eye that decorates the church above, but the Eye that marks the Temple of the Wheel in dreams. The priests of the Sun would tell you there was no sight before the rising of the Sun; but those who've drunk from this spring will dream of another sun, one that swung lower in the sky, one that would speak with us, one that would accept friendly gifts of blood from us.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moon: 10, nectar: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "sacredspring.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "This too dates from the time of the Abbey... but in summer, neither sisters nor brothers were permitted to spend more than a single hour here, lest the 'temptation of savours' overwhelm them.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 4, nectar: 4 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "scentgarden.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "The Curia's last secret. Right under Governor Collers' nose, Levinsen, Blackwood and van Lauren all continued their careful investigations of the Brancrug sea-caves. Many of the species here are unknown to Cornwall. Some have not been seen anywhere under this Sun.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moon: 3, scale: 3 },
        forbidden: {},
        essential: { circumstance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "Look out across the bay. Long long ago, this was a forest.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "Guidance",
        description: "These sands can be treacherous. Ask a guide the way.",
        required: { moon: 2, winter: 2 },
        forbidden: { reluctant: 1 },
        essential: { assistance: 1 },
      },
    ],
    fx: { "secondbeach.open": 1 },
    warmup: 0,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    startdescription:
      "A crooning whisper haunts this room. It must once have been luxurious, and will be again once I have it restored, but I will need help to lay the restless presence that drifts here.",
    desc: "In the days of the Dewulfs, this chamber was reserved for the heir of the House - though it was originally furnished for Hafren, the woman of 'uncertain lineage' who became Baron Walter's mother and bequeathed her unusual pale eyes and hair to Walter and his descendants.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moon: 5, rose: 5 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "severnchamber.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    startdescription: "If the Isle had a heart, we would hear its pulse.",
    desc: "The Carapace Cross, the hybrid race who in their many kinds were winged, legged, eyed, bright, dark, scaled, feathered, chitinous... and us? The Cross are gone; the Cross were always History; but to their children, their enemies, they leave this hushed legacy.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { scale: 15, moth: 15 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "shrinetosttentreto.open": 1 },
    warmup: 60,
  ...
  },
  {
    ...
    desc: "Did the Curia of the Isle construct this vault? They were not Long - most of them were not Long. So they were not the Obliviates, that society of unseen immortals bound by three oaths. But this vault does seem to reference the oath called the Silver Chain, which forbade men to lie with woman, or women with men: 'for what may come is not always the Crime of the Sky, yet that is a furious danger.'",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 14, knock: 14 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "silvervault.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  ...
  },
  {
    ...
    desc: "This room was once for the meditation of favoured visionaries. Here White Matilda prophesied the victory of the Iron King in the Wars of the Roads, much as it would occur three hundred years later. (She got his name wrong, though.) ",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { lantern: 10, heart: 10, winter: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    desc: "'Vestibulum Transitus' was the wry name the Curia gave this structure. Before that it was 'Valentine's Bridge', the sheltered crossing beyond which Baron Valentine's solitude was assured.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
  ...
  },
  {
    ...
    startdescription:
      "The ceiling bows worryingly under a damp patch. There must be a leak in the observatory. The Sun above knows what state it's in. I should seek help, and enter carefully.",
    desc: "Thomas Dewulf, second Baron Brancrug, who they called 'Baron Silence', built this observatory in 1576 - by happy coincidence, just in time to observe the passage of the Great Comet in 1577.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 2, sky: 2 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "watchmanstower2.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    label: "Well",
    startdescription:
      "The well is choked and filthy. It'll need to be purified inside and out.",
    desc: "There's been a well here since the days of the Sisterhood, and superstitions have gathered around it like leaves in drifts. Its water has a healing virtue if drawn on a night of the new moon. It's ill luck to draw from it if you hear an owl. If you drip the blood of a living enemy into the well, they'll drown. And so on. Certainly, when Numa comes, the mists lie thick here.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { moon: 7, nectar: 7 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
  ...
  },
  {
    ...
    label: "Well Descent",
    startdescription: "Leaves, flowers, and thorns. Especially thorns.",
    desc: "Rungs line the well's side. This must lead down to the oldest part of the Isle, to the shrines of the Sisterhood. It may be that the servants of the Dewulf family still came here in secret, even while they paid lip service to the rites of the Unconquered Sun.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { nectar: 8, scale: 8, moon: 8 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "welldescent.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "'By God, Sir, we shall have no Cigars in the Library, and we shall have no House without a Smoking-Room.' Dr Ambrose Westcott (1734-1797)",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { lantern: 5, forge: 5 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "westcottroom.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "This was the stair that the priestesses walked, in the time that this was the Abbey of the Black Dove. Their carved faces still guard the walls. Their prayers may still be heard when the airs of the Isle are exceptionally still.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { rose: 12, moon: 12 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "whisperingstair.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "In the days of the brethren, every day this gallery would ring with the Liturgy of the Hours. In the times of the Dewulfs and of the Curia, there were services here every Sunday. All those times are long gone. This is a house of echoes now.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { forge: 8, lantern: 8, sky: 8 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "windlitgallery.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
  {
    ...
    desc: "Ricardo Milagro, traveller, rascal, Musgrave's gardener, managed a creditable wine from Brancrug grapes. Cornwall has never really been wine country, and the tradition was unevenly maintained, but the Curia of the Isle kept a good cellar.",
    preslots: [
      {
        id: "infoRecipeInput",
        label: "#UI_ROOMINPUT_LABEL#",
        description: "#UI_ROOMINPUT_DESCRIPTION#",
        required: { grail: 10, moth: 10 },
        forbidden: {},
        essential: { assistance: 1 },
      },
    ],
    fx: { "winecellar.open": 1 },
    warmup: 60,
    actionid: "terrain.unlock",
    craftable: true,
  },
